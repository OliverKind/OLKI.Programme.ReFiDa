;NSIS Installer for ReFiDa 3.0.6.11
...
Section ""
  ...
  File ".\..\bin\Release\ReFiDa.exe"
  File ".\..\bin\Release\ReFiDa.exe.config"
  ...
  !insertmacro MUI_STARTMENU_WRITE_BEGIN Application
    ...
    CreateShortCut "$SMPROGRAMS\$StartMenuFolder\ReFiDa.lnk" "$INSTDIR\ReFiDa.exe"
