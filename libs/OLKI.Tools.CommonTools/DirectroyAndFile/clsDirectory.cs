...
using OLKI.Programme.ReFiDa.libs.OLKI.Tools.CommonTools.DirectroyAndFile;
using System;
using System.IO;
    ...
    public static class Directory
    {
        ...
        public static bool CheckAccess(string path, bool showMessageIfNoAccess)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    MessageBox.Show(string.Format(clsDirectory_Stringtable.CheckAccess_Exception_Message, new object[] { path, ex.Message }), clsDirectory_Stringtable.CheckAccess_Exceptionn_Caoption, MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                else
                {
        ...
        public static bool Copy(string sourcePath, string destPath, bool copySubDirs)
        {
            ...
            {
                MessageBox.Show(string.Format(clsDirectory_Stringtable.Copy_Exception_Message, new object[] { sourcePath, destPath, ex.Message }), clsDirectory_Stringtable.Copy_Exceptionn_Caoption, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        #endregion
        ...
        public static bool Create(string path, string templatePath)
        {
            ...
            {
                MessageBox.Show(string.Format(clsDirectory_Stringtable.Create_Exception_Message, new object[] { path, ex.Message }), clsDirectory_Stringtable.Create_Exception_Caoption, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        #endregion
        ...
        public static bool Delete(string path, bool showSecurityQuestion)
        {
            try
            {
                if ((!showSecurityQuestion || MessageBox.Show(string.Format(clsDirectory_Stringtable.Delete_Confirm_Message, new object[] { path }), clsDirectory_Stringtable.Delete_Confirm_Caoption, MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning, MessageBoxDefaultButton.Button3) == DialogResult.Yes) && System.IO.Directory.Exists(path))
                {
            ...
            {
                MessageBox.Show(string.Format(clsDirectory_Stringtable.Delete_Exception_Message, new object[] { path, ex.Message }), clsDirectory_Stringtable.Delete_Exceptionn_Caoption, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return false;
            }
        }
        #endregion
        ...
        public static bool Open(string path, bool askForCreateFolder, string templatePath)
        {
            ...
            if (!System.IO.Directory.Exists(path))
            {
                ...
                if (askForCreateFolder && MessageBox.Show(string.Format(clsDirectory_Stringtable.Open_AskCreate_Message, new object[] { path }), clsDirectory_Stringtable.Open_ExceptionOpen_AskCreate_Caoption, MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1) == DialogResult.Yes)
                {
                    ...
                    if (Create(path, templatePath))
                    {
                        ...
                        {
                            MessageBox.Show(string.Format(clsDirectory_Stringtable.Open_Exception_Message, new object[] { path, ex.Message }), clsDirectory_Stringtable.Open_Exceptionn_Caoption, MessageBoxButtons.OK, MessageBoxIcon.Error);
                            return false;
                        }
                    }
                    else
